<template lang="html">
  ...
  <div class="pay">
    ...
    <div class="pay-address">
      <div>
        <p class="main-address-per">收货人:<span>小玥玥</span></p>
        <p class="main-address-tel">18888888888</p>
      </div>
      <p>收货地址:<span>云南省楚雄彝族自治州楚雄市秦岭路8号院59号单元28层15号东户第三家</span></p>
    </div>
